define(["require", "exports", "../utils/createElement", "./getRootListNode", "../region/getSelectedBlockElementsInRegion", "../region/isNodeInRegion", "../selection/Position", "../utils/safeInstanceOf", "../utils/shouldSkipNode", "../jsUtils/toArray", "./VList", "../utils/wrap", "../utils/getLeafSibling", "./getListTypeFromNode"], function (require, exports, createElement_1, getRootListNode_1, getSelectedBlockElementsInRegion_1, isNodeInRegion_1, Position_1, safeInstanceOf_1, shouldSkipNode_1, toArray_1, VList_1, wrap_1, getLeafSibling_1, getListTypeFromNode_1) {
    "use strict";
