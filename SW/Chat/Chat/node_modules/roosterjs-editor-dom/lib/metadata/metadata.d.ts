 ...
 */
export declare function getMetadata<T>(element: HTMLElement, definition?: Definition<T>, defaultValue?: T): T | null;
/**
 ...
 */
export declare function setMetadata<T>(element: HTMLElement, metadata: T, def?: Definition<T>): boolean;
/**
 ...
 */
export declare function removeMetadata<T>(element: HTMLElement, metadataKey?: string): void;
