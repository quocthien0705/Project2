define(["require", "exports", "roosterjs-editor-dom", "roosterjs-editor-api"], function (require, exports, roosterjs_editor_dom_1, roosterjs_editor_api_1) {
    "use strict";
    ...
    var Watermark = /** @class */ (function () {
        ...
        Watermark.prototype.updateWatermark = function (watermark) {
            ...
            var watermarks = this.editor.queryElements((0, roosterjs_editor_dom_1.getEntitySelector)(ENTITY_TYPE));
            var isShowing = watermarks.length > 0;
            // re-render watermark only if it's already displayed
            if (isShowing) {
                // hide watermark
                var watermarks_1 = this.editor.queryElements((0, roosterjs_editor_dom_1.getEntitySelector)(ENTITY_TYPE));
