...
export const _createStatefulChatClientWithDeps = (chatClient, args, options) => {
    const context = new ChatContext(options === null || options === void 0 ? void 0 : options.maxStateChangeListeners, /* @conditional-compile-remove(teams-inline-images-and-file-sharing) */ args.credential, /* @conditional-compile-remove(teams-inline-images-and-file-sharing) */ args.endpoint);
    let eventSubscriber;
