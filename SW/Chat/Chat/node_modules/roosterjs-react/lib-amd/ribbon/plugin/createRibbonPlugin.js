define(["require", "exports", "roosterjs-editor-api", "../component/buttons/insertLink", "roosterjs-editor-dom"], function (require, exports, roosterjs_editor_api_1, insertLink_1, roosterjs_editor_dom_1) {
    "use strict";
    ...
    var RibbonPluginImpl = /** @class */ (function () {
            ...
            switch (event.eventType) {
                ...
                case 0 /* KeyDown */:
                    if (event.rawEvent.key == 'k' &&
                        ...
                        this.handleButtonClick(insertLink_1.insertLink, 'insertLinkTitle', undefined);
        ...
        RibbonPluginImpl.prototype.updateFormat = function () {
            ...
            if (this.editor && this.onFormatChanged) {
                var newFormatState_1 = (0, roosterjs_editor_api_1.getFormatState)(this.editor);
                if (!this.formatState ||
                    (0, roosterjs_editor_dom_1.getObjectKeys)(newFormatState_1).some(function (key) { var _a; return newFormatState_1[key] != ((_a = _this.formatState) === null || _a === void 0 ? void 0 : _a[key]); })) {
     ...
     * @param options The options for ribbon plugin to allow insert link on hot key press.
     */
    function createRibbonPlugin(delayUpdateTime, options) {
        return new RibbonPluginImpl(delayUpdateTime, options);
    }
    exports.default = createRibbonPlugin;
});
