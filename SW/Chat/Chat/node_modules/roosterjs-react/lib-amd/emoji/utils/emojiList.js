define(["require", "exports", "tslib", "roosterjs-editor-dom"], function (require, exports, tslib_1, roosterjs_editor_dom_1) {
    ...
    })(EmojiFamilyKeys = exports.EmojiFamilyKeys || (exports.EmojiFamilyKeys = {}));
    /**
     * @internal
    ...
    function forEachEmojiFamily(callback) {
        ...
        try {
            for (var families_1 = (0, tslib_1.__values)(families), families_1_1 = families_1.next(); !families_1_1.done; families_1_1 = families_1.next()) {
    ...
    function forEachEmoji(callback) {
        forEachEmojiFamily(function (emojis) {
            var e_2, _a;
            try {
                for (var emojis_1 = (0, tslib_1.__values)(emojis), emojis_1_1 = emojis_1.next(); !emojis_1_1.done; emojis_1_1 = emojis_1.next()) {
    ...
    function getEmojiCodePoint(key) {
        ...
        return String.fromCharCode.apply(String, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(surrogatePairs), false));
    }
