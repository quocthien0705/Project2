define(["require", "exports", "tslib", "react", "./EmojiIcon", "./EmojiNavBar", "./EmojiStatusBar", "@fluentui/react/lib/Callout", "../utils/emojiList", "@fluentui/react/lib/Utilities", "@fluentui/react/lib/FocusZone", "../../common/index", "@fluentui/react/lib/Styling", "../utils/searchEmojis", "@fluentui/react/lib/TextField", "@fluentui/react/lib/Theme"], function (require, exports, tslib_1, React, EmojiIcon_1, EmojiNavBar_1, EmojiStatusBar_1, Callout_1, emojiList_1, Utilities_1, FocusZone_1, index_1, Styling_1, searchEmojis_1, TextField_1, Theme_1) {
    "use strict";
    ...
    var EmojiPane = React.forwardRef(function EmojiPaneFunc(props, ref) {
        ...
        var emojiBody;
        var input;
        var _a = (0, tslib_1.__read)(React.useState(0), 2), index = _a[0], setIndex = _a[1];
        var _b = (0, tslib_1.__read)(React.useState(0 /* Quick */), 2), mode = _b[0], setMode = _b[1];
        var _c = (0, tslib_1.__read)(React.useState(emojiList_1.CommonEmojis), 2), currentEmojiList = _c[0], setCurrentEmojiList = _c[1];
        var _d = (0, tslib_1.__read)(React.useState("People" /* People */), 2), currentFamily = _d[0], setCurrentFamily = _d[1];
        var _e = (0, tslib_1.__read)(React.useState(':'), 2), search = _e[0], setSearchString = _e[1];
        var _f = (0, tslib_1.__read)(React.useState(''), 2), searchInBox = _f[0], setSearchInBox = _f[1];
        ...
        var renderQuickPicker = function (props, index, currentEmojiList) {
            ...
            return (React.createElement("div", { id: listId, role: "listbox" },
                ...
                React.createElement("div", { id: listId, role: "listbox", className: (0, Utilities_1.css)(classNames.quickPicker, classNames.roosterEmojiPane) },
                    React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({}, TooltipCalloutProps, { role: "tooltip", target: target, hidden: !content || !emojiList, className: classNames.tooltip }), content))));
        };
        ...
        var renderPartialList = function (props, index, currentEmojiList) {
            ...
            return (React.createElement("div", null,
                ...
                !hideStatusBar && (React.createElement(EmojiStatusBar_1.default, (0, tslib_1.__assign)({ classNames: classNames, strings: strings }, statusBarProps, { hasResult: hasResult, emoji: getSelectedEmoji() })))));
        };
        var renderFullList = function (props, index, currentFamily, currentEmojiList) {
            ...
            return (React.createElement("div", { className: classNames.fullList },
                React.createElement("div", { className: classNames.fullListBody, "data-is-scrollable": true, tabIndex: TabIndexForFirefoxBug, ref: onEmojiBodyRef },
                    React.createElement(EmojiNavBar_1.default, (0, tslib_1.__assign)({ strings: strings }, navBarProps, { onClick: pivotClick, currentSelected: currentFamily, getTabId: getTabId, classNames: classNames })),
    ...
    var getEmojiPaneClassName = (0, Utilities_1.memoizeFunction)(function (theme) {
