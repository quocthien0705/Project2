...
export default interface ContextMenuItem<TString extends string, TContext = never> {
     ...
     */
    onClick: (key: TString, editor: IEditor, targetNode: Node, strings: LocalizedStrings<TString> | undefined, uiUtilities: UIUtilities, context?: TContext) => void;
    /**
     ...
     */
    itemRender?: (item: IContextualMenuItem, onClick: (e: React.MouseEvent<Element> | React.KeyboardEvent<Element>, item: IContextualMenuItem) => void) => React.ReactNode;
    /**
