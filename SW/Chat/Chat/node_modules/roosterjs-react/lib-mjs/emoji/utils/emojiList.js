 ...
 * @internal
 */
export var CommonEmojis = [Common1, common2, common3, common4, common5, MoreEmoji];
/**
 * @internal
 */
// eslint-disable-next-line etc/no-const-enum
export var EmojiFamilyKeys;
...
})(EmojiFamilyKeys || (EmojiFamilyKeys = {}));
/**
 * @internal
 * NOTE: name for an emoji should be in lower case
 */
export var EmojiList = (_a = {},
    _a["People" /* People */] = [
        createEmoji('1f601'),
        createEmoji('1f602'),
        common5,
 ...
 * @internal
 */
export var EmojiFabricIconCharacterMap = (_b = {},
 ...
 * @internal
 */
export function forEachEmojiFamily(callback) {
    var e_1, _a;
    var families = getObjectKeys(EmojiList);
    try {
        for (var families_1 = __values(families), families_1_1 = families_1.next(); !families_1_1.done; families_1_1 = families_1.next()) {
            var family = families_1_1.value;
        ...
        try {
            if (families_1_1 && !families_1_1.done && (_a = families_1.return)) _a.call(families_1);
        }
 ...
 * @internal
 */
export function forEachEmoji(callback) {
...
function getEmojiCodePoint(key) {
    ...
    return String.fromCharCode.apply(String, __spreadArray([], __read(surrogatePairs), false));
}
