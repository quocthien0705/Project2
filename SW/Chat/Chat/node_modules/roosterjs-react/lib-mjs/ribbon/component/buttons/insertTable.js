...
function InsertTablePane(props) {
    ...
    var _b = __read(React.useState(1), 2), col = _b[0], setCol = _b[1];
    var _c = __read(React.useState(1), 2), row = _c[0], setRow = _c[1];
    ...
    var onClickButton = React.useCallback(function (e) {
        onClick(e, __assign(__assign({}, item), { key: createKey(row, col) }));
    }, [row, col, onClick]);
    ...
    return (React.createElement("div", { className: classNames.tablePaneInner },
        ...
        React.createElement(FocusZone, { defaultActiveElement: "cell_1_1", direction: FocusZoneDirection.bidirectional, onActiveElementChanged: updateSize }, items)));
}
...
function parseKey(key) {
    var _a = __read(key.split(','), 2), row = _a[0], col = _a[1];
    return {
        row: parseInt(row),
        col: parseInt(col),
    };
