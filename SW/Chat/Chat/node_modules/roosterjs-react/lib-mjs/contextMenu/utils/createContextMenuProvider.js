    ...
    ContextMenuProviderImpl.prototype.convertMenuItems = function (item, node) {
        ...
        return {
            ...
            subMenuProps: item.subItems
                ? __assign({ onItemClick: function (_, menuItem) { return menuItem && _this.onClick(item, menuItem.data); }, items: getObjectKeys(item.subItems).map(function (key) {
                        var _a;
                        return ({
                            key: key,
                            data: key,
                            text: getLocalizedString(_this.strings, key, (_a = item.subItems) === null || _a === void 0 ? void 0 : _a[key]),
 ...
 * @param shouldAddMenuItems A general checker to decide if we should add this group of menu items
 */
export default function createContextMenuProvider(menuName, items, strings, shouldAddMenuItems, context) {
