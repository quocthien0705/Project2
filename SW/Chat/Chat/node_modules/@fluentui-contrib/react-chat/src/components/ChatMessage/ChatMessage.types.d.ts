 ...
 * ChatMessage Props
 */
export type ChatMessageProps = Omit<ComponentProps<Partial<ChatMessageSlots>, 'body'>, 'className' | 'style' | 'ref' | 'id' | 'tabIndex'> & {
    /**
 ...
 */
export type ChatMessageState = ComponentState<ChatMessageSlots> & Pick<ChatMessageProps, 'attached' | 'decoration' | 'persistentTimestamp' | 'showAnimation'> & {
    /**
