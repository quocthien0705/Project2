 ...
 */
export declare type ArrayItemType<T extends any[]> = T extends (infer U)[] ? U : never;
/**
 ...
 */
export declare type ObjectPropertyDefinition<T extends Object> = {
 ...
 */
export declare type Definition<T> = CustomizeDefinition | (T extends any[] ? ArrayDefinition<T> : T extends Record<string, any> ? ObjectDefinition<T> : T extends String ? StringDefinition : T extends Number ? NumberDefinition : T extends Boolean ? BooleanDefinition : never);
