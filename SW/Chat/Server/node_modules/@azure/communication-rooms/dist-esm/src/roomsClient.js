...
import { mapCommunicationRoomToSDKModel, mapRoomParticipantForRemoval, mapRoomParticipantToRawId, mapToRoomParticipantSDKModel, } from "./models/mappers";
...
export class RoomsClient {
    ...
    listRoomsPage(pageSettings, options = {}) {
        return __asyncGenerator(this, arguments, function* listRoomsPage_1() {
            if (!pageSettings.continuationToken) {
                ...
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((room) => mapCommunicationRoomToSDKModel(room)));
                }
            }
            while (pageSettings.continuationToken) {
                const currentSetResponse = yield __await(this.client.rooms.listNext(pageSettings.continuationToken, options));
                pageSettings.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((room) => mapCommunicationRoomToSDKModel(room)));
                }
    ...
    listRoomsAll(options = {}) {
        return __asyncGenerator(this, arguments, function* listRoomsAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listRoomsPage({}, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listParticipantsPage(roomId, pageSettings, options = {}) {
        return __asyncGenerator(this, arguments, function* listParticipantsPage_1() {
            if (!pageSettings.continuationToken) {
                ...
                pageSettings.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map(mapToRoomParticipantSDKModel, this));
                }
            }
            while (pageSettings.continuationToken) {
                const currentSetResponse = yield __await(this.client.participants.listNext(roomId, pageSettings.continuationToken, options));
                pageSettings.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map(mapToRoomParticipantSDKModel, this));
                }
    ...
    listParticipantsAll(roomId, options = {}) {
        return __asyncGenerator(this, arguments, function* listParticipantsAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listParticipantsPage(roomId, {}, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    async addOrUpdateParticipants(roomId, participants, options = {}) {
        return tracingClient.withSpan("RoomsClient-AddOrUpdateParticipants", options, (updatedOptions) => {
